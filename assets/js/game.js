...
var startGame = function() { 
    ...
    for(var i = 0; i < enemyNames.length; i++) {
    if (playerHealth > 0) {
        // let player know what round they are in, remember arrays start at 0 so it needs a 1 added to it
        window.alert("Welcome to Robot-Galidators! Round" + ( i + 1));
        ...
        //pass the pickedEnemyName variable's value into the fight functions, where it wil assume the value of the enemyName parameter
   ...
   // after the loop ends, player is either out of health or enemies to fight, so run endGame fucntion
   endGame();
...
var endGame = function() {
    ...
    // ask play if they like to play again 
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like the REFILL you health , UPGRADE, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice."
    );
